...
def PublicAPI(*args, **kwargs):
    ...
    Public APIs are classes and methods exposed to end users.
    ...
    def wrap(obj):
        if stability in ["alpha", "beta"]:
            ...
            message = "PublicAPI: This API is stable across releases."
...
def DeveloperAPI(*args, **kwargs):
    ...
    Developer APIs are lower-level methods explicitly exposed to advanced
    ...
    def wrap(obj):
        _append_doc(
            obj,
            message="**DeveloperAPI:** This API may change across minor releases.",
        )
        _mark_annotated(obj)
        return obj
...
class CloudTikDeprecationWarning(DeprecationWarning):
...
if not sys.warnoptions:
    warnings.filterwarnings("module", category=CloudTikDeprecationWarning)


def Deprecated(*args, **kwargs):
    """Annotation for documenting a deprecated API.

    Deprecated APIs may be removed in future releases.
    ...
    Examples:
        >>> from cloudtik.core._private.annotations import Deprecated
        >>> @Deprecated
        ... def func(x):
        ...     return x
    ...
    warning_message = (
        "This API is deprecated and may be removed in future releases. "
    ...
    def inner(obj):
        ...
        if inspect.isclass(obj):
            ...
            def patched_init(*args, **kwargs):
                warnings.warn(warning_message, CloudTikDeprecationWarning, stacklevel=2)

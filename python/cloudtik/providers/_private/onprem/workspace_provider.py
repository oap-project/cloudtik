...
from cloudtik.providers._private.onprem.workspace_config \
    import get_workspace_head_nodes, list_onprem_clusters, _get_node_tags, check_onprem_workspace_integrity, \
    check_onprem_workspace_existence, create_onprem_workspace, delete_onprem_workspace
...
class OnPremWorkspaceProvider(WorkspaceProvider):
    ...
    def create_workspace(self, config: Dict[str, Any]):
        ...
        create_onprem_workspace(config)

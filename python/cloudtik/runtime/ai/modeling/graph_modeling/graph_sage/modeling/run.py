...
def _train_distributed(args):
    ...
    partitioned_node_embeddings_file = os.path.join(
        args.output_dir, "partitioned_node_embeddings.pt")
    ...
    job_command = (
        ...
        .format(
            ...
            exec_script=exec_script,
            model_file=args.model_file,
            node_embeddings_file=partitioned_node_embeddings_file,
            dataset_dir=dataset_dir,
            graph_name=args.graph_name,
            ip_config=ip_config,
            part_config=part_config,
    ...
    _map_node_embeddings(
        partitioned_node_embeddings_file,

...
from cloudtik.runtime.ai.runner.util.utils import _cache
from cloudtik.runtime.ai.runner.util import threads
...
def get_default_ip_address():
    return resolve_host_address(socket.gethostname())

...
from cloudtik.core._private.constants import CLOUDTIK_WAIT_FOR_JOB_FINISHED_INTERVAL_S, JOB_WAITER_TIMEOUT_MAX
...
class SparkJobWaiter(JobWaiter):
    ...
    def wait_for_completion(self, cmd: str, timeout: Optional[int] = JOB_WAITER_TIMEOUT_MAX):

...
from cloudtik.core._private.config_utils import subscribe_runtime_config, run_bash_scripts, run_system_command, \
    load_head_cluster_config, RUNTIME_CONFIG_KEY, with_script_args

from cloudtik.runtime.trino.utils import RUNTIME_ROOT_PATH, configure_connectors
...
def configure(head, head_address, script_args):
    ...
    runtime_config = load_head_cluster_config().get(
        RUNTIME_CONFIG_KEY) if head else subscribe_runtime_config()

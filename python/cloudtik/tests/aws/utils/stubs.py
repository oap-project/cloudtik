...
from cloudtik.tests.aws.utils import helpers
from cloudtik.tests.aws.utils.mocks import mock_path_exists_key_pair
from cloudtik.tests.aws.utils.constants import DEFAULT_INSTANCE_PROFILE, \

...
git apply $CLOUDTIK_HOME/runtime/spark/optimization/Support-a-rank-based-filter-to-optimize-top-k-comput.patch
git apply $CLOUDTIK_HOME/runtime/spark/optimization/Support-more-scenarios-for-runtime-Filter.patch

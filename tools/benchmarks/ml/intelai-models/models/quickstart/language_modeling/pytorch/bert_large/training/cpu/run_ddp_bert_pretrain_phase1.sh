...
python -m cloudtik-ml-run --distributed  --nnodes ${NNODES} --hosts ${HOSTS} --nproc_per_node $SOCKETS --log_path=${OUTPUT_DIR} --log_file_prefix="./throughput_log_phase1_${precision}" ${TRAIN_SCRIPT} \
